...
const ALLOWED_TABLES = new Set([
  ...
  'event_checkins', 'event_tickets', 'loss_reports', 'nostr_profiles', 'pending_nostr_events',
  'push_subscriptions', 'room_latest_posts', 'transaction_history', 'wallet_types', 'whats_up', 'faq'
]);
