...
--
-- Name: room_latest_posts; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: room_latest_posts room_latest_posts_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.room_latest_posts
    ADD CONSTRAINT room_latest_posts_pkey PRIMARY KEY (id);


--
-- Name: room_latest_posts room_latest_posts_room_slug_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.room_latest_posts
    ADD CONSTRAINT room_latest_posts_room_slug_key UNIQUE (room_slug);
...
--
-- Name: idx_room_latest_posts_created; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_room_latest_posts_created ON public.room_latest_posts USING btree (created_at DESC);


--
-- Name: idx_room_latest_posts_slug; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_room_latest_posts_slug ON public.room_latest_posts USING btree (room_slug);
...
--
-- Name: room_latest_posts update_room_latest_posts_updated_at; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER update_room_latest_posts_updated_at BEFORE UPDATE ON public.room_latest_posts FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();
...
--
-- Name: room_latest_posts Anyone can read room posts; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Anyone can read room posts" ON public.room_latest_posts FOR SELECT USING (true);
...
--
-- Name: room_latest_posts Service role can manage room posts; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Service role can manage room posts" ON public.room_latest_posts USING (true) WITH CHECK (true);
...
--
-- Name: room_latest_posts; Type: ROW SECURITY; Schema: public; Owner: -
--
