  ...
  if (variant === "bottom") {
    return (
      <nav className="fixed bottom-0 left-0 right-0 bg-card border-t z-50 pb-safe">
        <div className="flex items-center justify-around h-16 max-w-7xl mx-auto overflow-x-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
          {items.map((item, index) => {
              ...
              return (
                <div key={item.path} className="contents">
                  ...
                  <a
                    ...
                    className="flex flex-col items-center justify-center gap-0.5 px-2 py-2 min-w-[56px] flex-1 transition-colors text-muted-foreground hover:text-foreground"
                  >
            ...
            return (
              <div key={item.path} className="contents">
                ...
                <Link
                  to={item.path}
                  className={`flex flex-col items-center justify-center gap-0.5 px-2 py-2 min-w-[56px] flex-1 transition-colors ${
                    isActive
