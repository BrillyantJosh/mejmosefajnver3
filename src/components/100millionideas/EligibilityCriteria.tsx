...
/**
 * The "basis for participation" + "what kind of projects are eligible for
 * crowdfunding" criteria. Shared by the create-project gate (with an agree
 * button) and the info dialog on the Projects page. Slovenian for `sl`,
...
const SL: EligibilityContent = {
  eligibilityTitle: "Kateri projekti so upravičeni do financiranja?",
...
const EN: EligibilityContent = {
  eligibilityTitle: "What kind of projects are eligible for Crowdfunding?",
...
export function eligibilityContent(lang: SupportedLang): EligibilityContent {
  return lang === "sl" ? SL : EN;
}

/** The criteria body (no outer card, title or button). */
export function EligibilityCriteria({ lang }: { lang: SupportedLang }) {
    ...
    <div className="space-y-5">
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="space-y-2 min-w-0">
          <h3 className="text-base font-bold text-foreground">{c.basisTitle}</h3>
