...
import { useModules, moduleTitle, moduleDescription, moduleImage } from "@/contexts/ModulesContext";
...
const UNREGISTERED_MODULE_IDS: Set<ModuleType> = new Set([
  ...
  'chat', 'social', 'lanaexchange', 'being', 'theLanaLife'
]);
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-2 mb-6">
        ...
        const cardContent = <Card className="group hover:shadow-lg transition-all duration-300 hover:-translate-y-1 cursor-pointer h-full">
                <CardContent className="p-0">
                  {moduleImage(module, lang) ? <div className="h-48 rounded-t-lg relative overflow-hidden">
                      <img src={moduleImage(module, lang)} alt={moduleTitle(module, lang)} className={`w-full h-full object-cover group-hover:scale-105 transition-transform duration-300 ${module.imagePosition || ''}`} />
                  ...
                  <div className="p-6">
                    <div className="flex items-center justify-between mb-2">
                      <div className="flex items-center gap-1.5">
                        <h3 className="text-2xl font-bold">{moduleTitle(module, lang)}</h3>
                    ...
                    <p className="text-muted-foreground" dangerouslySetInnerHTML={{ __html: moduleDescription(module, lang) }} />
                  </div>
                </CardContent>
              </Card>;
                  ...
                  <CardContent className="p-4 flex items-center gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-1.5 mb-1">
                        <h3 className="text-lg font-semibold">{moduleTitle(module, lang)}</h3>
                        {!UNREGISTERED_MODULE_IDS.has(module.id) && (
                          <Badge variant="secondary" className="text-[10px] px-1.5 py-0 h-4 bg-teal-100 text-teal-700 dark:bg-teal-900 dark:text-teal-300">
                            Reg
                          </Badge>
                      ...
                      <p className="text-sm text-muted-foreground" dangerouslySetInnerHTML={{ __html: moduleDescription(module, lang) }} />
                    </div>
