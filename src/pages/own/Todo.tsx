  ...
  sl: {
    ...
    cmt: {
      ...
      howPoints: [
        ...
        "Lahko jo poveš tudi z glasom — nekaj minut, s svojimi besedami, ne z besedami bitja. Bitje te v glasu bolje začuti.",
      ],
  ...
  en: {
    ...
    cmt: {
      ...
      howPoints: [
        ...
        "You can also say it by voice — a few minutes, in your own words, not the being's. The being feels you more clearly in your voice.",
      ],
